...
Shopping Web 是一個基於 **Vue 3** 的前端購物網站，採用 **Vite** 進行開發，並整合 **Tailwind CSS** 和 **DaisyUI** 作為 UI 樣式框架。此專案旨在打造一個功能完整的電商平台，目前已實現 Google 第三方登入、商品瀏覽、購物車管理、分類篩選、結帳流程、訂單查詢及訂單詳情等功能。
...
- **會員功能**：
  ...
  - 訂單詳情頁面 (`OrderDetail.vue`) 顯示單一訂單的詳細資訊，包括收件人資料、付款狀態和商品列表。
- **錯誤處理**：
